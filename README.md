...
Source control characters, including escape sequences, are displayed visibly rather than sent to the terminal. ANSI styling generated by htail remains active, and pane widths use terminal-cell measurements so accented text, combining marks, CJK, emoji, ANSI styling, and tabs do not shift borders.
